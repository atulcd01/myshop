...
<div id="flipkart-navbar" ng-controller="categoryController">
    <div class="">
        ...
        <!-- search and cart bar -->
        <div class="container" style="display:flex;padding-bottom:5px;width:100%;">
        
            <div >
                
                <h1 style="margin:0px;"><span class="largenav"><a href="<c:url value='http://linux.machine.com/shop-application/protected/home'  />?a=<%= request.getParameter("a")%>"><font style="color:white;white-space: nowrap;font-family:Impact, Charcoal, sans-serif;">{{brand}}</font></a></span></h1>
	...
	<div class="col-12-12 _2tVp4j" style="color:black">
		...
		<button class="vh79eN" type="submit" onclick="location.href='http://linux.machine.com/shop-application/protected/products/'+document.getElementById('searchtext').value+' ?a=<%= request.getParameter("a")%>'">
	...
	<ul class="col-12-12 _1PBbw8" id="searchauto">
		<li class="_1va75j"><a class="_2ja22P"
			href="/search?q=cake+decoration+tools&amp;sid=upp%2Cbgd&amp;as=on&amp;as-show=on&amp;otracker=AS_QueryStore_OrganicAutoSuggest_0_3&amp;otracker1=AS_QueryStore_OrganicAutoSuggest_0_3&amp;as-pos=0&amp;as-type=HISTORY"><div
					class="prZF9U">
				...
				<div class="_2kpuIQ">
					...
					<div class="xOS6RD">in Bakeware</div>
				</div></a></li>
		...
		<li class="_1va75j"><a class="_2ja22P _2Yi_mU"
			href="/search?q=mobiles&amp;as=on&amp;as-show=on&amp;otracker=AS_Query_TrendingAutoSuggest_1_0&amp;otracker1=AS_Query_TrendingAutoSuggest_1_0&amp;as-pos=1&amp;as-type=TRENDING"><div
					class="prZF9U">
					<div class="_3BTv9X" style="height: 32px; width: 32px;">
						<img class="_1Nyybr _20scMb  _30XEf0" alt=""
				...
				<div class="_2kpuIQ">mobiles</div></a></li>
