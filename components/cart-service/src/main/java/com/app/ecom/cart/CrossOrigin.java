...
public class CrossOrigin implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
			...
			//System.out.println("In CrossOrigin.doFilter Method" + request.getLocalAddr());
	    ...
	    //String origin = ((HttpServletRequest) request).getHeader("origin");
		    ...
		    r.addHeader("Access-Control-Allow-Headers",
	            	...
	            	+ "refresh_token,Checksum,form_name,user_name,email");
		    r.addHeader("Access-Control-Expose-Headers","refresh_token,form_name,user_name,email");
