...
import com.install.model.AModel;
...
public class Main {
	...
	public static void main(String [] arg) throws Exception{
		...
		String applicationPropertyVersion=ctx.getEnvironment().getProperty("application.property.version");
		
		System.out.println("properties->"+applicationPropertyVersion);
		//mongoOperation.dropCollection(Category.class);
		// save createSampleData
		String baseid = null;
		 Pattern patt = Pattern.compile("\"([^\"]*)\"");
		 FileReader fileReader = new FileReader("/data/cakeshop.csv");
